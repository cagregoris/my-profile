...
const ContactForm = ({sendEmail}) => {
  ...
  return (
    <div className='container-form'>
      <h1>Get in Touch!</h1>
      <span id="cf-span">Dropping a line to say hello, or see if we can build something together? I'd love to hear from you! Fill in your info in the form below and I look forward to hearing from you!</span>
